...
def create_extras_document(output_path):
    ...
    items_data = [
        ("DP 01", "System Table (Desk Table)", "1m × 0.5m × 0.75m ht", "₹600", "$7", "Per day", "Furniture"),
        ("DP 02", "Wooden Table with cover", "5' × 2.5'", "₹400", "$5", "Per day", "Furniture"),
        ("DP 03", "Glass Round Table", "2'8\" Ø & 2'6\" ht", "₹1,400", "$15", "Per day", "Furniture"),
        ("DP 04", "Exhibition Chairs (White Chair)", "Standard exhibition seating", "₹700", "$8", "Per day", "Furniture"),
        ("DP 05", "Stake Chair (Cushioned Chair)", "Cushioned conference chair", "₹700", "$8", "Per day", "Furniture"),
        ("DP 06", "Apple Chair", "Modern designer seating", "₹500", "$6", "Per day", "Furniture"),
        ("DP 08", "Sofa Single Seat", "Plush armchair", "₹3,000", "$33", "Per day", "Furniture"),
        ("DP 09", "2 Seater Sofa (Sofa Double Seat)", "2-seater luxury lounge sofa", "₹5,000", "$55", "Per day", "Furniture"),
        ("DP 10", "3 Seater Sofa (Sofa Three Seat)", "3-seater spacious lounge sofa", "₹6,000", "$66", "Per day", "Furniture"),
        ("DP 11", "Rectangle Tipoi (Glass Centre Table)", "Glass top lounge center table", "₹1,200", "$13", "Per day", "Furniture"),
        ("DP 12", "Display Glass Counter (Without Lock)", "37.50\" × 18\" × 39\" ht (no light)", "₹2,500", "$28", "Per day", "Display & AV"),
        ("DP 13", "Display Glass Counter (With Lock)", "37.50\" × 18\" × 39\" ht (no light)", "₹3,000", "$33", "Per day", "Display & AV"),
        ("DP 14", "Tall Showcase (Without Lock)", "37.50\" × 18\" × 84\" ht (no light)", "₹4,000", "$44", "Per day", "Display & AV"),
        ("DP 14A", "Tall Showcase (With Lock)", "37.50\" × 18\" × 84\" ht (no light)", "₹5,000", "$55", "Per day", "Display & AV"),
        ("DP 15", "Brochure Stand (Brochure Rack)", "Folding catalogue display stand", "₹1,500", "$16", "Per day", "Display & AV"),
        ("DP 20", "Pedestrian Fan", "High power pedestal fan", "₹1,500", "$16", "Per day", "Electrical"),
        ("DP 21", "Glass Shelf", "1m × 10\"", "₹600", "$6", "Per day", "Display & AV"),
    ...
    order_table.cell(2, 0).paragraphs[0].add_run("Fascia Main Header (Option 1): ______________").font.size = Pt(8.5)
    order_table.cell(2, 1).paragraphs[0].add_run("Fascia Main Header (Option 2): ______________").font.size = Pt(8.5)
    order_table.cell(3, 0).paragraphs[0].add_run("Fascia Main Header (Option 3): ______________").font.size = Pt(8.5)
    order_table.cell(3, 1).paragraphs[0].add_run("Fascia Main Header (Option 4): ______________").font.size = Pt(8.5)
