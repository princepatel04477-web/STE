    ...
    <main className="min-h-screen bg-[#050505] text-expo-warm selection:bg-expo-gold/30 antialiased relative overflow-hidden py-24 sm:py-32">
      ...
      <div className="relative z-10 max-w-4xl mx-auto px-6 sm:px-12">
        ...
        >
          ...
          <Translate en="Back to Exhibition Home" hi="प्रदर्शनी होम पर वापस जाएं" />
        </Link>
        ...
        <div className="font-sans text-sm sm:text-base text-expo-warm/75 leading-relaxed space-y-8">
          <p>
            <Translate
              en="Surat Textile Exhibition (STE 2026), organized by AKAS Events, is committed to protecting the privacy and security of your business and personal information. This Privacy Policy describes how we collect, use, and safeguard data when you visit our website (stesurat.com), register as an exhibitor, book exhibition stalls, or submit inquiries."
              hi="अकास इवेंट्स द्वारा आयोजित सूरत टेक्सटाइल प्रदर्शनी (STE 2026), आपके व्यवसाय और व्यक्तिगत जानकारी की गोपनीयता और सुरक्षा की रक्षा करने के लिए प्रतिबद्ध है। यह गोपनीयता नीति बताती है कि जब आप हमारी वेबसाइट (stesurat.com) पर जाते हैं, एक प्रदर्शक के रूप में पंजीकरण करते हैं, प्रदर्शनी स्टॉल बुक करते हैं, या पूछताछ सबमिट करते हैं, तो हम डेटा को कैसे एकत्र, उपयोग और सुरक्षित करते हैं।"
            />
          </p>
          ...
          <section className="space-y-4">
            ...
            <div className="bg-white/5 border border-white/10 rounded-lg p-6 font-sans text-sm text-expo-warm/80 space-y-2 max-w-md">
              ...
              <p>
                <Translate en="Email: compliance@akasgroup.in" hi="ईमेल: compliance@akasgroup.in" />
              </p>
              <p>
              ...
              <p>
                <Translate 
                  en="Address: Surat International Exhibition and Convention Centre (SIECC), Sarsana, Surat, Gujarat - 395007" 
                  hi="पता: सूरत इंटरनेशनल एक्जीबिशन एंड कन्वेंशन सेंटर (SIECC), सरसाणा, सूरत, गुजरात - 395007" 
                />
              </p>
            </div>
          </section>
