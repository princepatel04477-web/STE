    ...
    >
      ...
      <div className="absolute inset-0 w-full h-full select-none pointer-events-none z-0">
        <OptimizedVideoBg
          ...
          className="w-full h-full filter brightness-[0.25] contrast-[1.1] saturate-[0.8]"
          fallbackImage={isTunnel ? "/assets/images/golden-fabric.webp" : "/assets/images/metallic-concentric.webp"}
        />
      ...
      <div
        ...
        style={{
          backgroundImage: isTunnel
            ...
            : `url('/assets/images/metallic-concentric.webp')`,
        }}
      />
