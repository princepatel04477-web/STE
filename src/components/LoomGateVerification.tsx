          ...
          <div>
            ...
            <p className="font-sans text-[9px] tracking-[1px] text-expo-warm/40 uppercase">
              {status === "success"
                ...
                : status === "verifying"
                ? (language === "en" ? "Analyzing interaction path..." : "इंटरैक्शन पथ का विश्लेषण...")
                : status === "invalid"
                ? (language === "en" ? "Verification failed. Try again." : "सत्यापन विफल। पुनः प्रयास करें।")
                : (language === "en" ? "Slide golden shuttle to unlock" : "अनलॉक करने के लिए सोने का शटल खिसकाएं")}
            </p>
          </div>
        </div>
        ...
        <AnimatePresence mode="wait">
          {status === "success" ? (
            ...
            >
              ...
              <span>{language === "en" ? "Identity Decrypted • Human Verified" : "पहचान सत्यापित • मानव सत्यापित"}</span>
            </motion.div>
          ) : status === "verifying" ? (
            // Verifying State UI
            <motion.div
