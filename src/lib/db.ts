...
export const EXTRA_PRODUCTS = [
  { id: 'desk-table', name: 'System Table / Desk Table', category: 'Furniture & Seating', description: '1m × 0.5m × 0.75m ht desk table', rate_inr: 600, unit: 'per-day', icon_name: 'table', is_active: 1 },
  { id: 'wooden-table', name: 'Wooden Table with cover', category: 'Furniture & Seating', description: "5' × 2.5' wooden table with cover", rate_inr: 400, unit: 'per-day', icon_name: 'table', is_active: 1 },
  { id: 'glass-round-table', name: 'Glass Round Table', category: 'Furniture & Seating', description: "2'8\" Ø & 2'6\" ht glass table", rate_inr: 1400, unit: 'per-day', icon_name: 'table', is_active: 1 },
  { id: 'white-chair', name: 'Exhibition Chair', category: 'Furniture & Seating', description: 'Standard exhibition seating', rate_inr: 700, unit: 'per-day', icon_name: 'chair', is_active: 1 },
  { id: 'cushioned-chair', name: 'Stake Chair', category: 'Furniture & Seating', description: 'Cushioned conference chair', rate_inr: 700, unit: 'per-day', icon_name: 'chair', is_active: 1 },
  { id: 'apple-chair', name: 'Apple Chair', category: 'Furniture & Seating', description: 'Modern designer seating', rate_inr: 500, unit: 'per-day', icon_name: 'chair', is_active: 1 },
  ...
  { id: 'sofa-double', name: '2 Seater Sofa', category: 'Furniture & Seating', description: '2-seater luxury lounge sofa', rate_inr: 5000, unit: 'per-day', icon_name: 'sofa', is_active: 1 },
  { id: 'sofa-three', name: '3 Seater Sofa', category: 'Furniture & Seating', description: '3-seater spacious lounge sofa', rate_inr: 6000, unit: 'per-day', icon_name: 'sofa', is_active: 1 },
  { id: 'glass-centre-table', name: 'Rectangle Tipoi', category: 'Furniture & Seating', description: 'Lounge glass centre table', rate_inr: 1200, unit: 'per-day', icon_name: 'table', is_active: 1 },
  { id: 'counter-without-lock', name: 'Display Glass Counter (Without Lock)', category: 'Display & AV', description: '37.50" × 18" × 39" ht (no light)', rate_inr: 2500, unit: 'per-day', icon_name: 'layers', is_active: 1 },
  { id: 'counter-with-lock', name: 'Display Glass Counter (With Lock)', category: 'Display & AV', description: '37.50" × 18" × 39" ht (no light)', rate_inr: 3000, unit: 'per-day', icon_name: 'layers', is_active: 1 },
  { id: 'tall-showcase-without-lock', name: 'Tall Showcase (Without Lock)', category: 'Display & AV', description: '37.50" × 18" × 84" ht (no light)', rate_inr: 4000, unit: 'per-day', icon_name: 'layers', is_active: 1 },
  { id: 'tall-showcase-with-lock', name: 'Tall Showcase (With Lock)', category: 'Display & AV', description: '37.50" × 18" × 84" ht (no light)', rate_inr: 5000, unit: 'per-day', icon_name: 'layers', is_active: 1 },
  { id: 'brochure-rack', name: 'Brochure Stand', category: 'Display & AV', description: 'Folding catalogue display stand', rate_inr: 1500, unit: 'per-day', icon_name: 'file-text', is_active: 1 },
  { id: 'glass-shelf', name: 'Glass Shelf', category: 'Display & AV', description: '1m × 10" wall mounted glass shelf', rate_inr: 600, unit: 'per-day', icon_name: 'layers', is_active: 1 },
  ...
  { id: 'garment-stand', name: 'Garment Stand (Single Rod)', category: 'Display & AV', description: "4.5'w × 5.5'ht single rod garment stand", rate_inr: 900, unit: 'per-day', icon_name: 'layers', is_active: 1 },
  { id: 'garment-stand-double', name: 'Garment Stand (Double Rod)', category: 'Display & AV', description: "4.5'w × 5.5'ht double rod garment stand", rate_inr: 900, unit: 'per-day', icon_name: 'layers', is_active: 1 },
  ...
  { id: 'mannequin', name: 'Mannequin', category: 'Display & AV', description: 'Full-body garment display mannequin (₹1,500 for 2 days)', rate_inr: 750, unit: 'per-day', icon_name: 'shirt', is_active: 1 },
  { id: 'rack', name: 'Rack', category: 'Display & AV', description: '5-tier aluminium display rack', rate_inr: 1500, unit: 'per-day', icon_name: 'layers', is_active: 1 },
  { id: 'receptionist', name: 'Receptionist', category: 'Display & AV', description: 'Professional stall receptionist / hostess (per day)', rate_inr: 1000, unit: 'per-day', icon_name: 'user', is_active: 1 },
  ...
  { id: 'metal-halide', name: 'Metal Halide Light', category: 'Electrical & Lighting', description: 'Spotlight / 50W LED fixture', rate_inr: 1500, unit: 'per-day', icon_name: 'zap', is_active: 1 },
  ...
  { id: 'plug-point', name: 'Plug Point', category: 'Electrical & Lighting', description: '5 / 15 amp single phase socket', rate_inr: 250, unit: 'per-day', icon_name: 'zap', is_active: 1 },
  ...
  { id: 'plasma-32', name: '32" Plasma Screen with Stand', category: 'Display & AV', description: '32-inch display with floor stand', rate_inr: 3500, unit: 'per-day', icon_name: 'tv', is_active: 1 },
